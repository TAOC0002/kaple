...
def load_and_cache_features(args, logger, dataset_type, tokenizer):
    ...
    if os.path.exists(cached_features_file):
        ...
        features = build_examples_and_convert_to_features(dataset_type+'.tsv', 'cross', max_seq_length, tokenizer)
    ...
    all_label_ids = torch.tensor([f.label for f in features], dtype=torch.float32)
