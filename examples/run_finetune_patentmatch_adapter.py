...
class patentModel(nn.Module):
    ...
    def forward(self, pretrained_model_outputs, input_ids, token_type_ids=None, attention_mask=None, labels=None,
        ...
        return outputs  # (loss), reshaped_logits
...
def main():
    ...
    if args.do_train:
        ...
        for step in bar:
            ...
            outputs = patent_model(pretrained_model_outputs,input_ids=input_ids, token_type_ids=segment_ids, attention_mask=input_mask, labels=label_ids)
                ...
                for file in ['valid.jsonl']:
                    ...
                    for input_ids, input_mask, segment_ids, label_ids in eval_dataloader:
                        ...
                        with torch.no_grad():
                            ...
                            tmp_eval_loss = patent_model(pretrained_model_outputs, input_ids=input_ids, token_type_ids=segment_ids, attention_mask=input_mask, labels=label_ids)
                            logits = patent_model(pretrained_model_outputs, input_ids=input_ids, token_type_ids=segment_ids, attention_mask=input_mask)
