...
def main():
    ...
    parser.add_argument("--score_range", default=5, type=str,
     ...
     parser.add_argument("--min_steps", default=10, type=str,
                        help="Minimum steps to enable early stopping.")
            ...
            if args.do_eval and ((global_step + 1) % args.eval_steps == 0) and eval_flag:
                ...
                for file in ['valid.jsonl']:
                    ...
                    if args.local_rank in [-1, 0]:
                        ...
                        eval_spearmanr = spearmanr(inference, gold)[0]
                        eval_pearsonr = pearsonr(inference, gold)[0]
